view: cfms_old {
  derived_table: {
    sql: WITH step1 AS( -- Build a CTE containing all events using the name_tracker "cfms_old"
...
# Build measures and dimensions
    ...
    dimension: back_office_with_drill {
      ...
      link: {
        ...
        url: "
        {% assign table_calc = '[{\"table_calculation\":\"total_time_credit\",\"label\":\"Total Time Credit\",\"expression\":\"${cfms_old.prep_duration_total}+${cfms_old.reception_duration_total}+${cfms_old.serve_duration_total}\",\"value_format\":\"[h]:mm:ss\",\"value_format_name\":null,\"_kind_hint\":\"measure\",\"_type_hint\":\"number\"},{\"table_calculation\":\"total_time_credit_percent\",\"label\":\"Total Time Credit Percent\",\"expression\":\"${total_time_credit}/sum(pivot_row(${total_time_credit}))\",\"value_format\":null,\"value_format_name\":\"percent_1\",\"_kind_hint\":\"measure\",\"_type_hint\":\"number\"}]' %}
        {% assign filter_config = '{\"cfms_old.office_name\":[{\"type\":\"=\",\"values\":[{\"constant\":\"\"},{}],\"id\":3,\"error\":false}],\"cfms_old.date\":[{\"type\":\"anytime\",\"values\":[{},{}],\"id\":4,\"error\":false}],\"cfms_old.back_office\":[{\"type\":\"=\",\"values\":[{\"constant\":\"\"},{}],\"id\":5,\"error\":false}]}' %}
        {% assign vis_config = '
        {\"stacking\":\"percent\" ,
        \"colors\":[\"#991426\" ,
        \"#a9c574\" ,
        ...
        \"totals_color\":\"#808080\" ,
        \"type\":\"looker_column\" ,
        \"hidden_fields\":[\"cfms_old.prep_duration_total\" ,
        \"cfms_old.reception_duration_total\" ,
        \"cfms_old.serve_duration_total\" ,
        \"total_time_credit_percent\"] ,
        \"y_axes\":[]}' %}

        {{ dummy_for_back_office._link }}&vis_config={{ vis_config | encode_uri }}&pivots=cfms_old.channel&sorts=cfms_old.channel 0,total_time_credit desc 3&limit=1000&column_limit=50&filter_config={{ filter_config | encode_uri }}&dynamic_fields={{ table_calc | replace: '  ', '' | encode_uri }}"
    ...
    dimension: program_name_with_drill_1{
      ...
      link: {
        ...
        url: "
        {% assign table_calc = '[]' %}
        {% assign filter_config = '{\"cfms_old.office_name\":[{\"type\":\"=\",\"values\":[{\"constant\":\"\"},{}],\"id\":6,\"error\":false}],\"cfms_old.program_name\":[{\"type\":\"=\",\"values\":[{\"constant\":\"Other\"},{}],\"id\":7,\"error\":false}],\"cfms_old.date\":[{\"type\":\"past\",\"values\":[{\"constant\":\"60\",\"unit\":\"day\"},{}],\"id\":8,\"error\":false}]}' %}
        {% assign vis_config = '
        {\"stacking\":\"normal\" ,
        \"colors\":[\"#991426\" ,
        \"#a9c574\" ,
        ...
        {{ dummy._link }}&vis_config={{ vis_config | encode_uri }}&pivots=cfms_old.channel&sorts=cfms_old.channel 0,cfms_old.transactions_count desc 6&limit=1000&column_limit=50&row_total=right&filter_config={{ filter_config| encode_uri }}&dynamic_fields={{ table_calc | replace: '  ', '' | encode_uri }}"
      }
    }
    ...
    dimension: program_name_with_drill_2 {
      ...
      link: {
        label: "Service Time"
        url: "
        {% assign table_calc = '[{\"table_calculation\":\"average_service_time\",\"label\":\"Average Service Time\",\"expression\":\"${cfms_old.prep_duration_per_visit_average}+${cfms_old.serve_duration_per_visit_average}+${cfms_old.reception_duration_per_visit_average}\",\"value_format\":\"[h]:mm:ss\",\"value_format_name\":null,\"_kind_hint\":\"measure\",\"_type_hint\":\"number\"}]' %}
        {% assign filter_config = '{\"cfms_old.office_name\":[{\"type\":\"=\",\"values\":[{\"constant\":\"\"},{}],\"id\":8,\"error\":false}],\"cfms_old.program_name\":[{\"type\":\"=\",\"values\":[{\"constant\":\"\"},{}],\"id\":9,\"error\":false}],\"cfms_old.date\":[{\"type\":\"anytime\",\"values\":[{},{}],\"id\":10,\"error\":false}],\"cfms_old.back_office\":[{\"type\":\"=\",\"values\":[{\"constant\":\"Front Office\"},{}],\"id\":11,\"error\":false}]}' %}
        {% assign vis_config = '
        {\"stacking\":\"\" ,
        \"colors\":[\"#991426\" ,
        \"#a9c574\" ,
        ...
        \"totals_color\":\"#808080\" ,
        \"type\":\"looker_column\" ,
        \"hidden_fields\":[\"cfms_old.prep_duration_per_visit_average\" ,
        \"cfms_old.reception_duration_per_visit_average\" ,
        \"cfms_old.serve_duration_per_visit_average\"] ,
        \"y_axes\":[]}' %}
